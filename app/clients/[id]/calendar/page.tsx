...
export default async function ClientCalendarPage({
  ...
  return (
    <LayoutShell
      ...
      hidePageHeader
    >
      <ClientWorkspaceTabs companyId={company.id} active="calendar" />

      {query.notice === 'updated' && (
        <section className="panel panel-stack">
          <div className="inline-row">
            <span className="status-dot ok" />
            <strong>Calendar setup saved.</strong>
          </div>
      ...
      <section className="panel panel-stack client-record-hero">
        <div className="record-header">
          <div className="panel-stack">
            <div className="metric-label">Calendar workspace</div>
      ...
      <div className="client-record-layout">
        <div className="panel-stack">
          <section className="panel panel-stack">
            <div className="record-header">
              <div className="panel-stack">
                ...
                <h3 className="section-title">How we should handle calendar sync</h3>
                <div className="record-subtitle">
            ...
            <div className="surface-link-grid">
              ...
              <div className="surface-link-card">
                ...
                <strong>Existing booking platform sync</strong>
          ...
          <section className="panel panel-stack">
            <div className="record-header">
              <div className="panel-stack">
                <div className="metric-label">Calendar setup</div>
                <h3 className="section-title">Store the rollout plan</h3>
                <div className="record-subtitle">
                  This tab gives each client a visible calendar integration plan now, even before full Google OAuth and writeback are automated.
                </div>
              </div>
            </div>
            ...
            <form action={saveClientCalendarSetupAction} className="panel-stack client-profile-form">
              ...
              <div className="client-profile-section">
                ...
                <div className="workspace-filter-row">
                  <div className="field-stack">
                    <label className="key-value-label" htmlFor="calendar-connection-mode">
                      Mode
                    </label>
                    <select id="calendar-connection-mode" className="select-input" name="connectionMode" defaultValue={state.connectionMode || 'google_oauth'}>
                  ...
                  <div className="field-stack">
                    <label className="key-value-label" htmlFor="calendar-timezone">
                      Timezone
                    </label>
                    <input
                  ...
                  <div className="field-stack">
                    <label className="key-value-label" htmlFor="calendar-duration">
              ...
              <div className="client-profile-section">
                ...
                <div className="workspace-filter-row">
                  <div className="field-stack">
                    <label className="key-value-label" htmlFor="calendar-google-email">
                  ...
                  <div className="field-stack">
                    <label className="key-value-label" htmlFor="calendar-google-id">
                      Google Calendar ID
                    </label>
                    <input
                ...
                <div className="workspace-filter-row">
                  <div className="field-stack">
                    <label className="key-value-label" htmlFor="calendar-shared-name">
                      Shared FYL calendar name
                    </label>
                    <input
                      id="calendar-shared-name"
                      className="text-input"
                  ...
                  <div className="field-stack">
                    <label className="key-value-label" htmlFor="calendar-share-email">
                      Share with email
                    </label>
                    <input
              ...
              <div className="client-profile-section">
                ...
                <div className="workspace-filter-row">
                  <div className="field-stack">
                    <label className="key-value-label" htmlFor="calendar-platform-name">
                      Platform name
                    </label>
                    <input
                      id="calendar-platform-name"
                      className="text-input"
                  ...
                  <div className="field-stack">
                    <label className="key-value-label" htmlFor="calendar-platform-url">
                      Platform URL
                    </label>
                    <input
                      id="calendar-platform-url"
                      className="text-input"
                  ...
                  <div className="field-stack">
                    <label className="key-value-label" htmlFor="calendar-external-id">
                      External calendar or location ID
                    </label>
                    <input
                      id="calendar-external-id"
                      className="text-input"
              ...
              <div className="client-profile-section">
                ...
                <div className="field-stack">
                  <label className="key-value-label" htmlFor="calendar-notes">
                    Booking sync notes
                  </label>
                  <textarea
                    id="calendar-notes"
          ...
          <section className="panel panel-stack">
            ...
            <div className="workspace-list">
              {recentSetupEvents.length === 0 ? (
                <div className="workspace-list-item">
                  <span className="tiny-muted">No calendar setup saves yet.</span>
                </div>
              ) : (
